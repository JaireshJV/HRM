...
export const ExpenseTableContainer = () => {
    ...
    const AddExpense = () => {
        ...
        setModalContent(<ExpenseTableForm formname={'ExpenseAddForm'} FormExternalClose={FormExternalClose} formReset={formReset} />);
        showModal();
    };
    ...
    return (
        ...
        <CustomCardView>
            ...
            <CustomPageFormTitle Heading={'View Expense Table'} />
            <Flex flexEnd={'true'} gap={'20px'} margin={'10px 0'}>
                <Button.Primary text={'+ Add '} onClick={AddExpense} />
            </Flex>
