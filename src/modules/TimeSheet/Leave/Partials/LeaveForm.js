...
import { getAttendance, selectAllAttendance } from '../../../../Store/CustomSlice/TimeSheetSlice'
...
export const LeaveForm = () => {
    ...
    const ReportPayroll = (values) => {
        request.post('attendance/date/list', values)
    ...
    return (
        <Fragment>
            ...
            <LeaveTable dataSource={dataSource} />
        </Fragment>
    )
}
